...
import com.bangkitcapstone.tipsntrip.databinding.FragmentDayFiveBinding

class DayFiveFragment(val agenda: Agenda) : Fragment() {
    private lateinit var binding: FragmentDayFiveBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDayFiveBinding.inflate(layoutInflater)
        return binding.root
    }
