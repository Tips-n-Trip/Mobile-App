...
class DayOneFragment(val agenda: Agenda) : Fragment() {
    private lateinit var binding: FragmentDayOneBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDayOneBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val agendaAdapter = AgendaAdapter(agenda.attractions)
        binding.rvAttraction.adapter = agendaAdapter
