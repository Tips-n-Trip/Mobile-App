...
import com.bangkitcapstone.tipsntrip.databinding.FragmentDayThreeBinding

class DayThreeFragment(val agenda: Agenda) : Fragment() {
    private lateinit var binding: FragmentDayThreeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDayThreeBinding.inflate(layoutInflater)
        return binding.root
    }
