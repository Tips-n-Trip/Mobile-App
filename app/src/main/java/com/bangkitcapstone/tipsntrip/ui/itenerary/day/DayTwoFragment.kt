...
import com.bangkitcapstone.tipsntrip.databinding.FragmentDayTwoBinding

class DayTwoFragment(val agenda: Agenda) : Fragment() {
    private lateinit var binding: FragmentDayTwoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDayTwoBinding.inflate(layoutInflater)
        return binding.root
    }
