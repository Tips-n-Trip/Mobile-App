...
import com.bangkitcapstone.tipsntrip.ui.explore.destination.CityDestinationViewModel
...
class PagingSourceFactory(private val pagingRepository: ExplorePagingRepository) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(CityDestinationViewModel::class.java)) {
            return CityDestinationViewModel(pagingRepository) as T
        }
